...
<body>
   ...
   <div class="col-md-4">
    <a href="add_country.php"><button class="btn btn-primary">Add Country</button></a><br>
   
    </div>
    <div class="col-md-4">
 
    <a href="add_course.php"><button class="btn btn-primary">Add Course</button></a><br>

    </div>
    <div class="col-md-4">
 
    <a href="add_city.php"><button class="btn btn-primary">Add City</button></a><br>
    </div>
    </div>
</body>
</html>