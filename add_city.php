...
{		
    ...
    $insert = mysqli_query($db,"INSERT INTO `city`(`city_name`,`country_id`) VALUES ('$city','$country')");
...
?>
       ...
       {  
        ...
        {
            echo "<option value='". $data['id'] ."'>" .$data['country'] ."</option>";  // displaying data in option menu
        }	
             ?> 
                </select>
                </div>
